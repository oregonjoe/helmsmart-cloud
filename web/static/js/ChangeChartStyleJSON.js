...
//***************************************************
var DialEnd = 1;
var NumOfDials = new Array(1,2,2,3,4,4,6,5,6,6,2,3,4,1);
...
var DialUnitsText = new Array("Fahrenheit","Celsius","Kelvin","- - -","Knots","MPH","KPH","- - -","PSI","KPASCAL","INHG","- - -","TRUE","MAGNETIC","- - -","- - -","DEGREES","Radians","Gallons/hr","Liters/hr","Liters","Gallons","CubicMeter","- - -","RPM","%","Volts","Amps",  "- - -","- - -","- - -","- - -");
...
if(document.getElementById("OverlayScale"))
{
...
// Sets the current dial Id
  function setDialID(sel) {
	...
	//alert('Set UpdateInterval ' + UpdateInterval);
	//alert('Set DialTimeout ' + DialTimeout);
	document.getElementById("PGNTimeout").value = DialTimeout;
	document.getElementById("UpdateInterval").value = UpdateInterval/1000;

	  var myPGNString = GetPGNTypeFromSeries(DialPGNNumber[CurrentDialID], DialPGNInstance[CurrentDialID], DialPGNParameter[CurrentDialID]);
