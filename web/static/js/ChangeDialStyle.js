...
document.getElementById("PGNInstance").options.length = 0;
	...
	switch (selText)
	{
		case "127505":
			...
			document.getElementById("PGNInstance").options[48] = new Option("00-Live Well", 48);
			document.getElementById("PGNInstance").options[49] = new Option("01-Live Well", 49);
			document.getElementById("PGNInstance").options[50] = new Option("02-Live Well", 50);
			document.getElementById("PGNInstance").options[51] = new Option("03-Live Well", 51);
			document.getElementById("PGNInstance").options[52] = new Option("04-Live Well", 52);
			document.getElementById("PGNInstance").options[53] = new Option("05-Live Well", 53);
			document.getElementById("PGNInstance").options[54] = new Option("06-Live Well", 54);
			document.getElementById("PGNInstance").options[55] = new Option("07-Live Well", 55);
			document.getElementById("PGNInstance").options[56] = new Option("08-Live Well", 56);
			document.getElementById("PGNInstance").options[57] = new Option("09-Live Well", 57);
			document.getElementById("PGNInstance").options[58] = new Option("10-Live Well", 58);
			document.getElementById("PGNInstance").options[59] = new Option("11-Live Well", 59);
			document.getElementById("PGNInstance").options[60] = new Option("12-Live Well", 60);
			document.getElementById("PGNInstance").options[61] = new Option("13-Live Well", 61);
			document.getElementById("PGNInstance").options[62] = new Option("14-Live Well", 62);
			document.getElementById("PGNInstance").options[63] = new Option("15-Live Well", 63);

			document.getElementById("PGNInstance").options[64] = new Option("00-Oil", 64);
			document.getElementById("PGNInstance").options[65] = new Option("01-Oil", 65);
			document.getElementById("PGNInstance").options[66] = new Option("02-Oil", 66);
			document.getElementById("PGNInstance").options[67] = new Option("03-Oil", 67);
			document.getElementById("PGNInstance").options[68] = new Option("04-Oil", 68);
			document.getElementById("PGNInstance").options[69] = new Option("05-Oil", 69);
			document.getElementById("PGNInstance").options[70] = new Option("06-Oil", 70);
			document.getElementById("PGNInstance").options[71] = new Option("07-Oil", 71);
			document.getElementById("PGNInstance").options[72] = new Option("08-Oil", 72);
			document.getElementById("PGNInstance").options[73] = new Option("09-Oil", 73);
			document.getElementById("PGNInstance").options[74] = new Option("10-Oil", 74);
			document.getElementById("PGNInstance").options[75] = new Option("11-Oil", 75);
			document.getElementById("PGNInstance").options[76] = new Option("12-Oil", 76);
			document.getElementById("PGNInstance").options[77] = new Option("13-Oil", 77);
			document.getElementById("PGNInstance").options[78] = new Option("14-Oil", 78);
			document.getElementById("PGNInstance").options[79] = new Option("15-Oil", 79);


			document.getElementById("PGNInstance").options[80] = new Option("00-Black Water", 80);
			document.getElementById("PGNInstance").options[81] = new Option("01-Black Water", 81);
			document.getElementById("PGNInstance").options[82] = new Option("02-Black Water", 82);
			document.getElementById("PGNInstance").options[83] = new Option("03-Black Water", 83);
			document.getElementById("PGNInstance").options[84] = new Option("04-Black Water", 84);
			document.getElementById("PGNInstance").options[85] = new Option("05-Black Water", 85);
			document.getElementById("PGNInstance").options[86] = new Option("06-Black Water", 86);
			document.getElementById("PGNInstance").options[87] = new Option("07-Black Water", 87);
			document.getElementById("PGNInstance").options[88] = new Option("08-Black Water", 88);
			document.getElementById("PGNInstance").options[89] = new Option("09-Black Water", 89);
			document.getElementById("PGNInstance").options[90] = new Option("10-Black Water", 90);
			document.getElementById("PGNInstance").options[91] = new Option("11-Black Water", 91);
			document.getElementById("PGNInstance").options[92] = new Option("12-Black Water", 92);
			document.getElementById("PGNInstance").options[93] = new Option("13-Black Water", 93);
			document.getElementById("PGNInstance").options[94] = new Option("14-Black Water", 94);
			document.getElementById("PGNInstance").options[95] = new Option("15-Black Water", 95);
			
			document.getElementById("PGNInstance").options[96] = new Option("00-Bilge ", 96);
			document.getElementById("PGNInstance").options[97] = new Option("01-Bilge ", 97);
			document.getElementById("PGNInstance").options[98] = new Option("02-Bilge ", 98);
			document.getElementById("PGNInstance").options[99] = new Option("03-Bilge ", 99);
			document.getElementById("PGNInstance").options[100] = new Option("04-Bilge ", 100);
			document.getElementById("PGNInstance").options[101] = new Option("05-Bilge ", 101);
			document.getElementById("PGNInstance").options[102] = new Option("06-Bilge ", 102);
			document.getElementById("PGNInstance").options[103] = new Option("07-Bilge ", 103);
			document.getElementById("PGNInstance").options[104] = new Option("08-Bilge ", 104);
			document.getElementById("PGNInstance").options[105] = new Option("09-Bilge ", 105);
			document.getElementById("PGNInstance").options[106] = new Option("10-Bilge ", 106);
			document.getElementById("PGNInstance").options[107] = new Option("11-Bilge ", 107);
			document.getElementById("PGNInstance").options[108] = new Option("12-Bilge ", 108);
			document.getElementById("PGNInstance").options[109] = new Option("13-Bilge ", 109);
			document.getElementById("PGNInstance").options[110] = new Option("14-Bilge ", 110);
			document.getElementById("PGNInstance").options[111] = new Option("15-Bilge ", 111);
			
			document.getElementById("PGNInstance").options[112] = new Option("00-Coolant ", 112);
			document.getElementById("PGNInstance").options[113] = new Option("01-Coolant ", 113);
			document.getElementById("PGNInstance").options[114] = new Option("02-Coolant ", 114);
			document.getElementById("PGNInstance").options[115] = new Option("03-Coolant ", 115);
			document.getElementById("PGNInstance").options[116] = new Option("04-Coolant ", 116);
			document.getElementById("PGNInstance").options[117] = new Option("05-Coolant ", 117);
			document.getElementById("PGNInstance").options[118] = new Option("06-Coolant ", 118);
			document.getElementById("PGNInstance").options[119] = new Option("07-Coolant ", 119);
			document.getElementById("PGNInstance").options[120] = new Option("08-Coolant ", 120);
			document.getElementById("PGNInstance").options[121] = new Option("09-Coolant ", 121);
			document.getElementById("PGNInstance").options[122] = new Option("10-Coolant ", 122);
			document.getElementById("PGNInstance").options[123] = new Option("11-Coolant ", 123);
			document.getElementById("PGNInstance").options[124] = new Option("12-Coolant ", 124);
			document.getElementById("PGNInstance").options[125] = new Option("13-Coolant ", 125);
			document.getElementById("PGNInstance").options[126] = new Option("14-Coolant ", 126);
			document.getElementById("PGNInstance").options[127] = new Option("15-Coolant ", 127);
