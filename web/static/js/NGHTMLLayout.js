...
switch(parseInt(PageLayout & 0x0F))
{
	...
	//alert('2X1');
		...
		'</tr>' +
		'<tr><td colspan="2"><center><canvas id="canvasClock" onclick="GetDialStyleInfo(0);" width="201" height="101"></canvas></center></td></tr>' +
		'<tr><td colspan="2" width="100%  width="25%" ><center><p align="center"><a href="#" onclick="resetFuelTotal(0); id="resetFuel" class="persona-button"><span style="display:block; width:120px">Reset Total </span></a></center></td></tr>' +
		'</table>';
	break;
