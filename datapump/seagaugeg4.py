...
<FUELTOTAL>0</FUELTOTAL>
  ...
  pgnxml = pgnxml +  '<PGNI0>'    +  getPGNIstr_from_tag( request, 'PGNI0', 'PGNP0') + '</PGNI0>'
  pgnxml = pgnxml +  '<PGNI1>'    +  getPGNIstr_from_tag( request, 'PGNI1', 'PGNP1') + '</PGNI1>'
  pgnxml = pgnxml +  '<PGNI2>'    +  getPGNIstr_from_tag( request, 'PGNI2', 'PGNP2') + '</PGNI2>'
  pgnxml = pgnxml +  '<PGNI3>'    +  getPGNIstr_from_tag( request, 'PGNI3', 'PGNP3') + '</PGNI3>'
  pgnxml = pgnxml +  '<PGNI4>'    +  getPGNIstr_from_tag( request, 'PGNI4', 'PGNP4') + '</PGNI4>'
  pgnxml = pgnxml +  '<PGNI5>'    +  getPGNIstr_from_tag( request, 'PGNI5', 'PGNP5') + '</PGNI5>'
  pgnxml = pgnxml +  '<PGNI6>'    +  getPGNIstr_from_tag( request,  'PGNI6', 'PGNP6') + '</PGNI6>'
  pgnxml = pgnxml +  '<PGNI7>'    +  getPGNIstr_from_tag( request, 'PGNI7', 'PGNP7') + '</PGNI7>'
  pgnxml = pgnxml +  '<PGNI8>'    +  getPGNIstr_from_tag( request, 'PGNI8', 'PGNP8') + '</PGNI8>'
  pgnxml = pgnxml +  '<PGNI9>'    +  getPGNIstr_from_tag( request,  'PGNI9', 'PGNP9') + '</PGNI9>'
  pgnxml = pgnxml +  '<PGNI10>'  +  getPGNIstr_from_tag( request,  'PGNI10', 'PGNP10')  + '</PGNI10>'
  pgnxml = pgnxml +  '<PGNI11>'  +  getPGNIstr_from_tag( request, 'PGNI11', 'PGNP11')  + '</PGNI11>'

  pgnxml = pgnxml +  '<PGNP0>'    +   getPGNPstr_from_tag( request, 'PGNI0', 'PGNP0')  + '</PGNP0>'
  pgnxml = pgnxml +  '<PGNP1>'    +   getPGNPstr_from_tag( request, 'PGNI1', 'PGNP1')  + '</PGNP1>'
  pgnxml = pgnxml +  '<PGNP2>'    +   getPGNPstr_from_tag( request, 'PGNI2', 'PGNP2')  + '</PGNP2>'
  pgnxml = pgnxml +  '<PGNP3>'    +   getPGNPstr_from_tag( request, 'PGNI3', 'PGNP3')  + '</PGNP3>'
  pgnxml = pgnxml +  '<PGNP4>'    +   getPGNPstr_from_tag( request, 'PGNI4', 'PGNP4')  + '</PGNP4>'
  pgnxml = pgnxml +  '<PGNP5>'    +   getPGNPstr_from_tag( request, 'PGNI5', 'PGNP5')  + '</PGNP5>'
  pgnxml = pgnxml +  '<PGNP6>'    +   getPGNPstr_from_tag( request, 'PGNI6', 'PGNP6')  + '</PGNP6>'
  pgnxml = pgnxml +  '<PGNP7>'    +   getPGNPstr_from_tag( request, 'PGNI7', 'PGNP7')  + '</PGNP7>'
  pgnxml = pgnxml +  '<PGNP8>'    +   getPGNPstr_from_tag( request, 'PGNI8', 'PGNP8')  + '</PGNP8>'
  pgnxml = pgnxml +  '<PGNP9>'    +   getPGNPstr_from_tag( request, 'PGNI9', 'PGNP9')  + '</PGNP9>'
  pgnxml = pgnxml +  '<PGNP10>'  +   getPGNPstr_from_tag( request, 'PGNI10', 'PGNP10') + '</PGNP10>'
  pgnxml = pgnxml +  '<PGNP11>'  +   getPGNPstr_from_tag( request,  'PGNI11', 'PGNP11') + '</PGNP11>'
